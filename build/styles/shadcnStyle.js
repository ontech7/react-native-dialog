 ...
 */
const shadowLg = "0px 10px 15px -3px rgba(0,0,0,0.1), 0px 4px 6px -4px rgba(0,0,0,0.1)";
...
const dark = {
    container: {
        ...
        boxShadow: "0px 10px 15px -3px rgba(0,0,0,0.5), 0px 4px 6px -4px rgba(0,0,0,0.5)",
    },
    header: {
        paddingHorizontal: 16,
        paddingTop: 16,
...
export const shadcnStyle = { light, dark };
